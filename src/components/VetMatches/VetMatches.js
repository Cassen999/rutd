...
class VetMatches extends Component {
  ...
  componentDidMount() {
    this.props.dispatch({
      ...
      payload: this.props.store.vetReducer.id,
    });
  ...
  contactOrg = (org_id, orgName, org_email) => {
    ...
    console.log(
      "Contacting Org and time, org_id, vet_id",
      time,
      org_id,
      state.vetId
    );
    this.props.dispatch({
      type: "POST_NEW_MATCH",
      payload: { vet_id: state.vetId, org_id: org_id, time: time },
    });
    this.props.dispatch({
      type: "POST_EMAIL",
      payload: {
        ...
        org_email: org_email,
        text: state.textbox,
        vetFirstName: state.vetFirstName,
        vetLastName: state.vetLastName,
          ...
          swal(
            ...
            this.props.dispatch({
              ...
              payload: {
                ...
                org_email: org_email,
                text:
                  "Reaching out again to get an application update or connect again",
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button
          onClick={(event) => this.props.history.push("/home")}
          variant="contained"
          style={{
            borderRadius: 35,
            width: "25px",
                  ...
                  <Card className={classes.card}>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <Typography component="p">{match.website}</Typography>
...
export default connect(mapStoreToProps)(
  withStyles(styles)(withRouter(VetMatches))
);
