...
// Toolbar,AppBar,Badge, CardMedia, IconButton, makeStyles, InputBase, Card, CardActionArea
            ...
            >
              ...
              <Grid item xs={12.0} sm={12}>
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    this.handleInputChange(event, "compensation")
                  }
                />
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    this.handleInputChange(event, "percentage")
                  }
                />
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    this.handleInputChange(event, "danger_areas")
                  }
                />
                ...
                <TextField
                  ...
                  onChange={(event) =>
                    this.handleInputChange(event, "purple_heart")
                  }
                />
              </Grid>
